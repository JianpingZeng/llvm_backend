//= Cse523IntelInstPrinter.h - Convert Cse523 MCInst to assembly syntax -*- C++ -*-=//
//
...
//===----------------------------------------------------------------------===//
//
// This class prints an Cse523 MCInst to Intel style .s file syntax.
//
//===----------------------------------------------------------------------===//

#ifndef CSE523_INTEL_INST_PRINTER_H
#define CSE523_INTEL_INST_PRINTER_H
...
class Cse523IntelInstPrinter : public MCInstPrinter {
public:
  Cse523IntelInstPrinter(const MCAsmInfo &MAI, const MCInstrInfo &MII,
