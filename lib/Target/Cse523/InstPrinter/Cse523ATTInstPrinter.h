//==- Cse523ATTInstPrinter.h - Convert Cse523 MCInst to assembly syntax -*- C++ -*-=//
//
...
//===----------------------------------------------------------------------===//
//
// This class prints an Cse523 MCInst to AT&T style .s file syntax.
//
//===----------------------------------------------------------------------===//

#ifndef CSE523_ATT_INST_PRINTER_H
#define CSE523_ATT_INST_PRINTER_H
...
class Cse523ATTInstPrinter : public MCInstPrinter {
public:
  Cse523ATTInstPrinter(const MCAsmInfo &MAI, const MCInstrInfo &MII,
