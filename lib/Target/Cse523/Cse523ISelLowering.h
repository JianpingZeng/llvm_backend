//===-- Cse523ISelLowering.h - Cse523 DAG Lowering Interface ----------*- C++ -*-===//
//
...
#ifndef CSE523ISELLOWERING_H
#define CSE523ISELLOWERING_H
...
namespace llvm {
  namespace Cse523ISD {
    ...
    enum NodeType {
      ...
      /// Cse523::SHLDxx and Cse523::SHRDxx instructions.
      SHLD,
      SHRD,

      /// FAND - Bitwise logical AND of floating point values. This corresponds
      /// to Cse523::ANDPS or Cse523::ANDPD.
      FAND,

      /// FOR - Bitwise logical OR of floating point values. This corresponds
      /// to Cse523::ORPS or Cse523::ORPD.
      FOR,

      /// FXOR - Bitwise logical XOR of floating point values. This corresponds
      /// to Cse523::XORPS or Cse523::XORPD.
      FXOR,

      /// FANDN - Bitwise logical ANDNOT of floating point values. This
      /// corresponds to Cse523::ANDNPS or Cse523::ANDNPD.
      FANDN,

      /// FSRL - Bitwise logical right shift of floating point values. These
      /// corresponds to Cse523::PSRLDQ.
      FSRL,

      /// CALL - These operations represent an abstract Cse523 call
      ...
      /// Cse523 compare and logical compare instructions.
      CMP, COMI, UCOMI,

      /// Cse523 bit-test instructions.
      BT,

      /// Cse523 SetCC. Operand 0 is condition code, and operand 1 is the EFLAGS
      ...
      /// Cse523 FP SETCC, implemented with CMP{cc}SS/CMP{cc}SD.
      /// Operands are two FP values to compare; result is a mask of
      /// 0s or 1s.  Generally DTRT for C/C++ with NaNs.
      FSETCC,

      /// Cse523 MOVMSK{pd|ps}, extracts sign bits of two or four FP values,
      /// result in an integer GPR.  Needs masking for scalar result.
      FGETSIGNcse523,

      /// Cse523 conditional moves. Operand 0 and operand 1 are the two values
      /// to select from. Operand 2 is the condition code, and operand 3 is the
      /// flag operand produced by a CMP or TEST instruction. It also writes a
      /// flag result.
      CMOV,

      /// Cse523 conditional branches. Operand 0 is the chain operand, operand 1
      ...
      /// REP_STOS - Repeat fill, corresponds to Cse523::REP_STOSx.
      REP_STOS,

      /// REP_MOVS - Repeat move, corresponds to Cse523::REP_MOVSx.
      REP_MOVS,
      ...
      /// WrapperRIP - Special wrapper used under Cse523-64 PIC mode for RIP
      ...
      /// i32, corresponds to Cse523::PEXTRB.
      PEXTRB,

      /// PEXTRW - Extract a 16-bit value from a vector and zero extend it to
      /// i32, corresponds to Cse523::PEXTRW.
      PEXTRW,
      ...
      /// corresponds to Cse523::PINSRB.
      PINSRB,

      /// PINSRW - Insert the lower 16-bits of a 32-bit value to a vector,
      /// corresponds to Cse523::PINSRW.
      PINSRW, MMX_PINSRW,
      ...
      /// TC_RETURN - Tail call return. See Cse523TargetLowering::LowerCall for
      ...
      // MUL_IMM - Cse523 specific multiply by immediate.
      MUL_IMM,
      ...
      /// to the Cse523::FIST*m instructions and the rounding mode change stuff. It
      ...
      /// Cse523::FILD*m instructions. It has three inputs (token chain, address,
      ...
      /// This corresponds to the Cse523::FLD32m / Cse523::FLD64m. It takes a chain
      /// operand, ptr to load from, and a ValueType node indicating the type
      /// to load to.
      FLD,

      /// FST - This instruction implements a truncating store to FP stack
      /// slots. This corresponds to the Cse523::FST32m / Cse523::FST64m. It takes a
  ...
  //===--------------------------------------------------------------------===//
  //  Cse523TargetLowering - Cse523 Implementation of the TargetLowering interface
  class Cse523TargetLowering : public TargetLowering {
  public:
    explicit Cse523TargetLowering(Cse523TargetMachine &TM);
    ...
    /// for all types except for some special cases. For example, on Cse523
    ...
    /// specified value type and it is 'desirable' to use the type. e.g. On cse523
    ...
    /// type Ty1 to type Ty2. e.g. On cse523 it's free to truncate a i32 value in
    ...
    /// does not necessarily apply to truncate instructions. e.g. on cse523-64,
    ...
    /// operations of type VT1 to VT2. e.g. on cse523, it's profitable to narrow
    ...
    virtual bool ShouldShrinkFPConstant(EVT VT) const {
      ...
      return !Cse523ScalarSSEf64 || VT == MVT::f80;
    }

    const Cse523Subtarget* getSubtarget() const {
      return Subtarget;
    }
  ...
  private:
    ...
    /// addLegalFPImmediate - Indicate that this cse523 target can instruction
    ...
    /// expand, the associated machine basic block, and the associated Cse523
    /// opcodes for reg/reg.
    ...
    // Utility function to emit the low-level va_arg code for Cse523-64.
    ...
    /// equivalent, for use with the given cse523 condition code.
    SDValue EmitTest(SDValue Op0, unsigned Cse523CC, SelectionDAG &DAG) const;

    /// Emit nodes that will be selected as "cmp Op0,Op1", or something
    /// equivalent, for use with the given cse523 condition code.
    SDValue EmitCmp(SDValue Op0, SDValue Op1, unsigned Cse523CC,
                    SelectionDAG &DAG) const;
